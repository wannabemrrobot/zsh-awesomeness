# Generated by Powerlevel10k configuration wizard on 2020-04-17 at 14:08 IST.
...
# 12h time, angled separators, sharp heads, blurred tails, 2 lines, solid, full frame,
...
if [[ $POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_GAP_CHAR != ' ' ]]; then
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION=' $(whoami) '
  typeset -g POWERLEVEL9K_CUSTOM_OS_ICON='  $(whoami) '
  ...
  #####################################[ quote: custom quote ]####################################
  #typeset -g POWERLEVEL9K_QUOTE_FOREGROUND='#EF2929'
  #typeset -g POWERLEVEL9K_QUOTE_BACKGROUND='#222730'
  #typeset -g POWERLEVEL9K_QUOTE_CONTENT_EXPANSION=""
  #typeset -g POWERLEVEL9K_QUOTE_VISUAL_IDENTIFIER_EXPANSION=''

  #####################################[ quotesf: custom quote ]####################################
  typeset -g POWERLEVEL9K_QUOTESF_FOREGROUND='#EF2929'
  #typeset -g POWERLEVEL9K_QUOTESF_BACKGROUND='#222730'
  typeset -g POWERLEVEL9K_QUOTESF_BACKGROUND=''
  #typeset -g POWERLEVEL9K_QUOTESF_CONTENT_EXPANSION=""
  #typeset -g POWERLEVEL9K_QUOTESF_VISUAL_IDENTIFIER_EXPANSION=''
  #typeset -g POWERLEVEL9K_FIRST_PROMPT_LEFT_SEGMENT_SEPARATOR=''
  typeset -g POWERLEVEL9K_LEFT_SUBSEGMENT_SEPARATOR=''

  #####################################[ quotesr: custom quote ]####################################
  typeset -g POWERLEVEL9K_QUOTESR_FOREGROUND='#EF2929'
  #typeset -g POWERLEVEL9K_QUOTESR_BACKGROUND='#222730'
  typeset -g POWERLEVEL9K_QUOTESR_BACKGROUND='transparent'
  #typeset -g POWERLEVEL9K_QUOTESR_CONTENT_EXPANSION=""
  #typeset -g POWERLEVEL9K_QUOTESR_VISUAL_IDENTIFIER_EXPANSION=''
  ...
  ################[ todo: todo items (https://github.com/todotxt/todo.txt-cli) ]################
  # Todo color.
  typeset -g POWERLEVEL9K_TODO_FOREGROUND='#EF2929'
  typeset -g POWERLEVEL9K_TODO_BACKGROUND=0
  ...
  #
  #typeset -g POWERLEVEL9K_TODO_CONTENT_EXPANSION='$P9K_TODO_FILTERED_TASK_COUNT - $P9K_TODO_TOTAL_TASK_COUNT'
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_VPN_IP_VISUAL_IDENTIFIER_EXPANSION=' Connected to $VPN'
  ...
  function prompt_example() {
    #p10k segment -b '#EF2929' -f 7 -i '   ' -t 'hello, %n'
     p10k segment -b '#EF2929' -f 7 -i ' ' -t ' hello, friend'
  ###########################             
  }
  function prompt_quote() {
    p10k segment -b 'transparent' -f 'white' -t "THE QUIETER YOU BECOME, THE MORE YOU'RE ABLE TO HEAR"
  }
  function prompt_quotesf() {
    p10k segment -b 'transparent' -f '#EF2929' -t ""
  }
  function prompt_quotesr() {
    p10k segment -b 'transparent' -f '#EF2929' -t ""
  }
